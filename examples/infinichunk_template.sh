...
ppo_mini_batch_size=128  # infinichunk config will dynamically adjust
...
multi_turn_max_assistant_turns=5 # max number of infinichunk turns (I)
...
overrides=(
  ...
  algorithm.infinichunk.keep_head=$keep_head
  algorithm.infinichunk.fixed_num_optim_steps=$fixed_num_optim_steps
  algorithm.infinichunk.use_flat_batch_correction_ratio=$use_flat_batch_correction_ratio
  algorithm.infinichunk.use_trimmer_class=$use_trimmer_class
  algorithm.infinichunk.trimmer_name=$trimmer_name
  algorithm.infinichunk.trimmer_kwargs=$trimmer_kwargs

  reward_model.reward_manager=infinichunk
...
CONFIG_NAME="r1d-1.5b_deepscaler_infinichunk_24k"

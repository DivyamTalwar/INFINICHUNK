...
@register("infinichunk")
class InfinichunkRewardManager(VineppoRewardManager):
    pass


@register("tenary_infinichunk")
class TenaryInfinichunkRewardManager(InfinichunkRewardManager):
    def __init__(
        self,
        *args,
...
@register("chunk_encourage_infinichunk")
class ChunkEncourageInfinichunkRewardManager(InfinichunkRewardManager):
    def __init__(
        self,
        *args,
...
@register("cosine_infinichunk")
class CosineInfinichunkRewardManager(InfinichunkRewardManager):
    def __init__(
        self,
        *args,
        ...
        **kwargs,
        ...
        self.infinichunk_gen_length = infinichunk_gen_length
        self.enabled = enabled
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            assistant_turns = num_turns - 1
            seq_length = valid_response_length + (assistant_turns - 1) * self.infinichunk_gen_length
            if score == 1:

...
@dataclass
class KeepingCheckpointConfig(CheckpointConfig):
    keep_every_n_saves: int = 1
    keep_only_hf_in_previous_saves: bool = False
    hf_repo_id: Optional[str] = None
    push_to_hub_freq: int = 0
    push_to_hub_enabled: bool = False
    push_to_hub_ignore_errors: bool = False

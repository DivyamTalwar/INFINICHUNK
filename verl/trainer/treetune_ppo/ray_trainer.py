...
Original PPO Trainer of verl with some goodies. No change to the logic.
"""
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("gen", timing_raw, color="red"):
                        fake_gen_output = self.config.algorithm.get("fake_generation_output", False)
                        if not fake_gen_output:
                            ...
                            from verl.utils.debug import create_fake_gen_output

                            gen_batch_output = create_fake_gen_output(
                                gen_batch,
                                max_response_length=self.config.data.max_response_length,
                                calculate_log_probs=self.config.actor_rollout_ref.rollout.get(
